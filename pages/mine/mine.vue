	...
	<view class="container">
		...
		<view class="mineTop">
			<view class="mineTop_left">
				<view class="mineTop_left_image"><image src="../../static/mine/timg.jpg" mode="" @click="toSend"></image></view>
				<view class="mineTop_left_info">
					<label for="" style="color: #fff;">{{userInfo==null?"未登录":userInfo.phone}}</label>
					<label for="">V1</label>
				</view>
			</view>
